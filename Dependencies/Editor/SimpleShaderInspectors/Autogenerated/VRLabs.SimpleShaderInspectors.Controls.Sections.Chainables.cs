namespace VRLabs.ToonyStandardRebuild.SimpleShaderInspectors.Controls.Sections
{
    public static partial class Chainables
    {
        ...
        public static ActivatableSection AddActivatableSection(this VRLabs.ToonyStandardRebuild.SimpleShaderInspectors.IControlContainer container, System.String activatePropertyName, System.Single enableValue = 1, System.Single disableValue = 0, string appendAfterAlias = "")
        {
        ...
        public static OrderedSection AddOrderedSection(this VRLabs.ToonyStandardRebuild.SimpleShaderInspectors.Controls.Sections.OrderedSectionGroup container, System.String activatePropertyName, System.Single enableValue = 1, System.Single disableValue = 0, string appendAfterAlias = "")
        {
        ...
        public static OrderedSectionGroup AddOrderedSectionGroup(this VRLabs.ToonyStandardRebuild.SimpleShaderInspectors.IControlContainer container, System.String alias, string appendAfterAlias = "")
        {
        ...
        public static Section AddSection(this VRLabs.ToonyStandardRebuild.SimpleShaderInspectors.IControlContainer container, System.String propertyName, System.Single hideValue = 0, System.Single showValue = 1, string appendAfterAlias = "")
        {
            var control = new Section(propertyName, hideValue, showValue);
            container.AddControl(control, appendAfterAlias);
            return control;
        }
        public static Section AddSection(this VRLabs.ToonyStandardRebuild.SimpleShaderInspectors.IControlContainer container, string appendAfterAlias = "")
        {
